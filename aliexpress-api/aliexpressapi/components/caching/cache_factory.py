...
# components/caching/cache_factory.py
...
class CacheFactory(BaseCache):
    """
    Generic cache factory for any namespace.
    Compatible with old code: cache_results(), get_results(), clear()
    """
    ...
    def __post_init__(self):
        super().__init__(self.namespace, default_ttl=self.default_ttl)
